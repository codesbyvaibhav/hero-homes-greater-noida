...
<head>
  ...
  <style>
    ...
    /* PROPERLY VISIBLE, BOLD & BIGGER H1 HEADER BLOCK */
    ...
    /* COMPACT, LOW-HEIGHT QUICK ANSWER BOX */
    ...
    /* RESPONSIVE MOBILE LAYOUT BALANCING - FLUSH HERO IMAGE WITH ZERO TOP GAP */
    @media (max-width: 768px) {{
      ...
      /* PROPERLY VISIBLE & BOLD H1 ON MOBILE (NO TRUNCATION, WRAPS NATURALLY) */
      .page-h1-header-block {{
      ...
      /* COMPACT, LOW-HEIGHT QUICK ANSWER BOX ON MOBILE */
      .aeo-direct-answer-box {{
    ...
    /* BULLETPROOF RESPONSIVE MOBILE TABLE FIX (max-width: 768px) - ZERO VERTICAL WORD BREAKING */
    @media (max-width: 768px) {{
      .table-responsive {{
        width: 100% !important;
      ...
      .table-domain-theme tr:nth-child(even),
      ...
      /* 2-COLUMN TABLES: PRECISE 46% LABEL / 54% VALUE PROPORTIONS */
      .table-compact-2col th:first-child,
      .table-compact-2col td:first-child,
      .table-text-2col th:first-child,
      .table-text-2col td:first-child {{
      ...
      /* CELL CONTENT FLEX WRAPPING & BADGE STYLING */
      .table-cell-title {{
        display: flex !important;
      ...
      /* BADGES & PILLS NEVER COMPRESS OR BREAK VERTICALLY */
      .price-highlight-pill,
      .status-badge {{
      ...
      /* MULTI-COLUMN TABLES SCROLL SMOOTHLY WITHOUT NARROW SQUEEZING */
      .table-amenities-3col,
      .table-domain-theme:not(.table-compact-2col):not(.table-text-2col) {{
...
<body>
  ...
  <footer class="site-footer compact-footer">
    <div class="container footer-content compact-subpage-footer">
...
print("build_child_pages.py updated with bigger, untruncated H1 titles and compact low-profile Quick Answer boxes.")

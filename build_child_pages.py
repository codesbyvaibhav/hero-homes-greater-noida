...
<head>
  ...
  <style>
    ...
    /* Layout Spacing Fix: Tight top padding directly on main container below fixed navbar */
...
print("build_child_pages.py updated with compact hero image height & tight spacing.")

...
<article class="content-block shadow-card rounded-large p-4 bg-white readable-text-container">
  ...
  <!-- TABLE #1: PRIMARY FEATURED PRICE LIST TABLE -->
  <div class="table-responsive">
    <table class="table-featured-price">
      <thead>
        <tr>
          <th>Configuration</th>
  ...
  <!-- TABLE #2: FLOOR PLAN SPECIFICATIONS TABLE -->
  <div class="table-responsive">
    <table class="table-specs-secondary">
      <thead>
        <tr>
          <th>Configuration</th>
          <th>Bedrooms</th>
  ...
  <!-- TABLE #3: CHECKLIST TABLE (INCLUDED / EXCLUDED) -->
  <div class="table-responsive">
  ...
  <!-- TABLE #4: LOCATION SNAPSHOT TABLE -->
  <div class="table-responsive">
    <table class="table-compact-location">
      <thead>
        <tr>
          <th>Landmark</th>
  ...
  <!-- TABLE #5: MARKET COMPARISON TABLE -->
  <div class="table-responsive">
    <table class="table-market-comparison">
      <thead>
        <tr>
          <th>Factor</th>
...
# Enhanced styling additions for pricing page
pricing_custom_styles = """
  <style>
    /* Readable Text Measure & Typography Scale */
    ...
    .content-subheading-lg {
      font-size: 1.55rem !important; /* 25px semibold */
    ...
    /* 1. TABLE #1: PRIMARY FEATURED PRICE LIST TABLE */
    .table-featured-price {
      ...
      box-shadow: 0 8px 24px rgba(194, 34, 41, 0.12);
      margin: 16px 0;
    }
    .table-featured-price th {
      background: linear-gradient(135deg, #C22229 0%, #0F172A 100%);
      color: #ffffff;
      padding: 12px 16px;
      font-size: 0.95rem;
      font-weight: 700;
    ...
    .table-featured-price td {
      padding: 12px 16px;
      border-bottom: 1px solid #f1f5f9;
      font-size: 0.94rem;
      color: #1e293b;
    }
    .table-featured-price tr:last-child td {
      border-bottom: none;
    }
    .price-highlight-pill {
      background: rgba(194, 34, 41, 0.08);
    ...
    /* 2. TABLE #2: SECONDARY SPECS TABLE */
    .table-specs-secondary {
      width: 100%;
    ...
    .table-specs-secondary th {
      background: #1e293b;
      color: #ffffff;
      padding: 10px 12px;
      font-size: 0.88rem;
    }
    .table-specs-secondary td {
      padding: 10px 12px;
    ...
    /* 3. TABLE #3: CHECKLIST TABLE (STATUS BADGES) */
    .table-checklist {
      width: 100%;
      border-collapse: collapse;
      margin: 16px 0;
    ...
    /* 4. TABLE #4: COMPACT LOCATION TABLE */
    .table-compact-location {
      width: 100%;
      border-collapse: collapse;
      margin: 16px 0;
      border: 1px solid #e2e8f0;
    ...
    .table-compact-location th {
      background: #334155;
      color: #ffffff;
      padding: 9px 12px;
      font-size: 0.88rem;
    }
    .table-compact-location td {
      padding: 9px 12px;
      border-bottom: 1px solid #f1f5f9;
      font-size: 0.88rem;
    }

    /* 5. TABLE #5: MARKET COMPARISON TABLE (HERO BRAND COLUMN) */
    ...
    .table-market-comparison td {
      padding: 10px 14px;
      border-bottom: 1px solid #e2e8f0;
      font-size: 0.88rem;
    }
    .table-market-comparison td.col-hero-brand {
      background: rgba(194, 34, 41, 0.04);
      font-weight: 600;
...
print("pricing.html redesigned with all 7 layout & scannability fixes!")
